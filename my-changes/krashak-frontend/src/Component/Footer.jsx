    ...
    >
      <div className="footer_content">
        <div className="footer_logo">
          <img src={assets.nxvLogoFull} alt="NXV Logo" className="footer_nxv_logo" />
          <p>
        ...
        <div className="footer_nav">
          ...
          <ul className="nav">
            ...
            <NavLink to="/customer-service" className="nav_link">
              Customer Support
            </NavLink>
            <NavLink to="/Products" className="nav_link">
              Products And Services
            </NavLink>
            <NavLink to="/Booking" className="nav_link">
              Book Service
            </NavLink>
            <NavLink to="/collab" className="nav_link">
              Our Collaborations
            </NavLink>
          </ul>
        </div>
      ...
      <div className="footer_copyright">
        <hr />
        <p>Copyright 2024@ NXV INTELLIGENT SYSTEMS - All Right Reserved</p>
      </div>
    </motion.div>
  );
}
